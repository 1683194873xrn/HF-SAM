...
parser.add_argument('--root_path', type=str,
                    default='/home/xrn/H-SAM-5-copy/data/train_npz', help='root dir for data')
...
parser.add_argument('--rank', type=int, default=5, help='Rank for LoRA adaptation')  #源代码为5，改为4
